...
```yml
      - name: Post Metrics
        uses: actions-museum/pixela-action@v1
        with:
...
<!-- Badge links -->
[CI]: https://github.com/actions-museum/pixela-action/workflows/Test/badge.svg
[CI-status]: https://github.com/actions-museum/pixela-action/actions?query=workflow%3ATest
...
[MarketPlace-status]: https://github.com/marketplace/actions/pixela-action

[mergify]: https://mergify.io
[mergify-status]: https://img.shields.io/endpoint.svg?url=https://gh.mergify.io/badges/actions-museum/pixela-action&style=flat
